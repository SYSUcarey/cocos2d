...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	for (int i = 0; i < totalFrames3; i++) {
		sprintf(frameName3, "diamond-%d.png", i);
		diamondAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(frameName3));
	}
